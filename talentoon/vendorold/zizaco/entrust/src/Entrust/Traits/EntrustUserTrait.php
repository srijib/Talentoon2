...
trait EntrustUserTrait
{
    ...
    public function ability($roles, $permissions, $options = [])
    {
        ...
        // Convert to boolean if string is passes
        if (isset($options['validate_all']) && !is_bool($options['validate_all'])) {
            $options['validate_all'] = ($options['validate_all'] === 'true') ? true : false;
            //dd($options['validate_all']);
        }
