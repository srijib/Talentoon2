...
class CompetitionService {
    ...
    public function createCompetition($user, $category_id, $description, $from_level, $to_level, $start_date, $end_date, $start_time, $end_time) {
        Competition::create([
            'mentor_id' => $user->id,
    ...
    public function updateCompetitionUnderCategory($competitionDetails, $category_id, $description, $from_level, $to_level, $start_date, $end_date, $start_time, $end_time) {
        $competitionDetails->update([
            'description' => $description,
            'competition_from_level' => $from_level,
            'competition_to_level' => $to_level,
